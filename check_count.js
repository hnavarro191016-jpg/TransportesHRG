async function check() {
  const url = 'https://tdopkvmuovqxxaxmkoan.supabase.co/rest/v1/romo_live_tracking_history?recorded_at=gte.2026-09-24T00:00:00Z&select=id';
  const headers = {
  ...
  try {
    ...
    console.log("Total count:", res.headers.get('content-range'));
  } catch(e) {
    console.error(e);
  }
}
